...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      // Hide the sheet overlay on small screens to avoid double-overlay when a Drawer is used for mobile.
      "hidden md:block fixed inset-0 z-50 bg-black/80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className
    )}
    {...props}
    ref={ref}
...
const sheetVariants = cva(
  // Keep styling minimal and based on globals.css variables; remove shadow and rounded values
